...
for vehicle_type in average_mpg_by_year_type['VClass'].unique():
    ...
    for i in range(len(subset)):
        plt.text(subset['year'].iloc[i], subset['average_mpg'].iloc[i], f'{subset["average_mpg"].iloc[i]:.2f}', fontsize=9)
...
plt.savefig(r'X:\Data-Mining-Project\Fuel-Economy-DataScience-Project\plots\avg_mpg_change.png', bbox_inches='tight')
